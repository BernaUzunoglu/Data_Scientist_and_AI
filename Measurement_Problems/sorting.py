...
df = pd.read_csv("Measurement_Problems/datasets/product_sorting.csv")
print(df.shape)
df.head(10)
...
####################
# Yorum ve satın alma oranlarının sayısının daha anlamlı olabilmesi için belirli biir scala içerisine almamız daha iyi olacaktır.
# Min max scaler ile verilen değişkeni 1-5 arasında fit ediyor ve trasnform metodu ile yeni değerleri yazıyor.
...
# Sorting Products with 5 Star Rated - 5 Yıldızşı sistemlerde ürün sıralama
# Sorting Products According to Distribution of 5 Star Rating - 5 Yıldızın dağılımına göre ürün sıralama


#  Bayesian Average Rating Score ne iş yapar : Puan dağılımları üzerinden ağırlıklı bir şekilde olasılıksal ortalama hesabı yapar.
#  confidence : hesaplamada elde edilecek z tablosu için bir sabit değeri temsil eder.
