...
# Sorulan soru sayısı ve ortalama puan değeri
...
# Zamansal olarak % ağırlıklı ortalama oranları hesaplanması
...
# Weighted Rating
####################
# Veri setinde %50 zaman %50 kullanıcı ağırlıklı oran hesaplama
def course_weighted_rating(dataframe, time_w=50, user_w=50):
    return time_based_weighted_average(dataframe) * time_w/100 + user_based_weighted_average(dataframe)*user_w/100

course_weighted_rating(df)

# Kursu tamamlama oranı daha önemli kabul edersek.
